                        ...
                        <div class="breadcrumb-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active" style="font-weight: lighter;" id="title-page"> <a href=""><i
                                            class='bx bxs-chevron-right'></i> Education Level </a></li>
                            </ol>
                        </div>
                        ...
                        <div class="dashboard-content">
                            ...
                            <div class="second-content">
                                ...
                                <div class="Voters-list-title">
                                    <h2 style="font-weight: 550;" class="header" id="breadcrup-title">DELETE EDUCATION LEVEL</h2>
                                </div>
                                <div class="voters-list-content">
                                    <div class="back-button">
                                        <button class="button-back"><a href="EducationLevel_Page_Admin.php" style="color:white; display:flex; align-items:center; gap: 3px;"><i class="bx bx-arrow-back"></i>Back</a></button>
                                    </div>
                                    ...
                                    <div id="addvoters-popup" class="addvoters-popup">
                                        ...
                                        <div class="addvoters-popup-forms">
                                            ...
                                            function deletePosition()
                                            {
                                                ...
                                                if ($result) {
                                                    header("Location: EducationLevel_Page_Admin.php?insert_msg=Education level has been deleted successfully");
                                                    exit();
                                                } else {
                                                    ...
                                                    <div class="content-wrapper">
                                                        <div class="form-section" style="margin-top: 5px;">
                                                            <label for="" style="color: #24724D; margin-bottom: 15px;">Education Level :
                                                                <p style="font-size: 24px; font-weight: bold; color: #4A4A4A;"><?php echo $row['educational_level']; ?></p>
                                                            </label>
                                                            <label for="" style="color: #24724D; margin-bottom: 15px;">Grade or Year Group :
                                                                <p style="font-size: 24px; font-weight: bold; color: #4A4A4A;"><?php echo $row['grade_year']; ?></p>
                                                            </label>
                                                            <label for="" style="color: #24724D; margin-bottom: 15px;">Number of Sections :
                                                                <p style="font-size: 24px; font-weight: bold; color: #4A4A4A;"><?php echo $row['max_section']; ?></p>
                                                            </label>
                                                        </div>
                                                    </div>
