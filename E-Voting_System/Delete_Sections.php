                        ...
                        <div class="dashboard-content">
                            ...
                            <div class="second-content">
                                ...
                                <div class="Voters-list-title">
                                    <h2 style="font-weight: 550;" class="header" id="breadcrup-title">DELETE SECTION</h2>
                                </div>
                                <div class="voters-list-content">
                                    <div class="back-button">
                                        <button class="button-back"><a href="Section_Page_Admin.php" style=" color:white; display:flex; align-items:center; gap: 3px;"><i class="bx bx-arrow-back"></i>Back</a></button>
                                    </div>
