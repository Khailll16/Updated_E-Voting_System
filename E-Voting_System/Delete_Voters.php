                                        ...
                                        <form action="" method="POST">
                                            ...
                                            <div class="content-wrapper">    
                                                ...
                                                <div class="form-section">
                                                    ...
                                                    <label for="" style="color: #24724D; margin-bottom: 15px;">Grade :
                                                        <p style="font-size: 24px; font-weight: bold; color: #4A4A4A;"><?php echo $row['grade_id']?></p>
                                                    </label>
                                                    <label for="" style="color: #24724D; margin-bottom: 15px;">Section :
                                                        <p style="font-size: 24px; font-weight: bold; color: #4A4A4A;"><?php echo $row['section_id']?></p>
                                                    </label>
                                                </div>
                                            </div>
