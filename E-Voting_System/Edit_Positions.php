                        ...
                        <div class="breadcrumb-content">
                            <ol class="breadcrumb">
                                ...
                                <li class="active" style="font-weight: lighter;" id="title-page"> <a href=""><i
                                            class='bx bxs-chevron-right'></i> Positions </a></li>
                            </ol>
                        </div>
                        ...
                        <div class="dashboard-content">
                            ...
                            <div class="second-content">
                                ...
                                <div class="Voters-list-title">
                                    <h2 style="font-weight: 550;" class="header" id="breadcrup-title">EDIT POSITION</h2>
                                </div>
                                <div class="voters-list-content">
                                    <div class="back-button">
                                        <button class="button-back"><a href="Position_Page_Admin.php" style="color: white;"><i
                                    ...
                                    <div id="addvoters-popup" class="addvoters-popup">
                                        ...
                                        <div class="addvoters-popup-forms">
                                            ...
                                            if (isset($_POST['update-pos'])) {
                                                ...
                                                $desc = $_POST['desc'];
                                                $maxvote = $_POST['maximum'];

                                                $sql = "UPDATE `positions` set `descrip` = '$desc',`max_vote` = '$maxvote' where `id` = '$pos_id' ";
                                                ...
                                                if (!$result) {
                                                    ...
                                                    header("Location: Position_Page_Admin.php?insert_msg=Position have been updated successfully");
                                                    exit();
                                                }
                                            }
                                            ...
                                            <form action="Edit_Positions.php?id_new=<?php echo $id; ?>" method="POST">
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="form-section">
                                                        ...
                                                        <label for="">Description
                                                            <input type="text" name="desc" class="input-field" value="<?php echo $row['descrip'] ?>">
                                                        </label>
                                                        <label for="">Maximum Vote
                                                            <input type="number" name="maximum" class="input-field" value="<?php echo $row['max_vote'] ?>">
                                                        </label>
