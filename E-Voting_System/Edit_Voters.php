                                        ...
                                        <div class="addvoters-popup-forms">
                                            ...
                                            if (isset($_POST['update-voters'])) {
                                                ...
                                                if (!$result) {
                                                    ...
                                                    header("Location: Voters_Page_Admin.php?insert_msg=Voter has been edit successfully");
                                                    exit();
                                                }
                                            }
                                                ...
                                                <div class="container">
                                                    ...
                                                    <div class="form-section">
                                                        ...
                                                        <label for="">First Name
                                                            <input type="text" name="votersfname" class="input-field" value="<?php echo $row['voters_firstname'] ?>">
                                                        </label>
                                                        <label for="">Last Name
                                                            <input type="text" name="voterslname" class="input-field" value="<?php echo $row['voters_lastname'] ?>">
                                                        </label>
                                                        <label for="">Grade
