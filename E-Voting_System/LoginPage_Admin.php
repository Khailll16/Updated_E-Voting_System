...
<head>
    ...
    <title>Admin Login Page | SIKHAY</title>
</head>
<body>
    <!-----Background----->
    ...
    <div class="image-container">
        ...
        <div class="back-button">
            <a href="SetUp_Organization.php"><button><i class='bx bx-arrow-back'></i> Back</button></a>
        </div>
        ...
        <div class="box">
            ...
            <div class="Login-box">
                <div class="login-content">
                    <form action="Login_admin_connect.php" class="form-login-admin" method="post">
                        <!------header----->
                        ...
                        <div class="input-container">
                            ...
                            <input class="input-field" type="text" placeholder="Username" name="admin_usrnm">
                        </div>
                        <div class="input-container">
                            <i class='bx bx-lock-alt'></i>
                            <input class="input-field" type="password" placeholder="Password" name="admin_psw">
                        </div>
