                    ...
                    <div class="dashboard-content">
                        ...
                        <div class="second-content">
                            ...
                            <div class="back-button">
                                ...
                                <button class="button-edit"><a href="Edit_WebSetup.php?id=<?php echo $row['id']; ?>" style="color: #24724D;"><i
                                            class='bx bx-edit'></i>Update</a></button>
                            </div>
                                    ...
                                    <form action="" method="POST">
                                        <div class="container">
                                            <div class="organization-name">
                                                ...
                                                <h2 style="color: #555555;">Name of organization :</h2>
                                                <p style="padding: 10px 30px; border: 2px solid #24724D; color: #555555; border-radius: 50px; font-size: 19px;"><?php echo $row['organization_name']; ?></p>
                                                <br>

                                                <h2 style="color: #555555;">Number :</h2>
                                                <p style="padding: 10px 30px; border: 2px solid #24724D; color: #555555; border-radius: 50px; font-size: 19px;"><?php echo $row['admin_number']; ?></p>
                                                <br>

                                                <h2 style="color: #555555;">Address :</h2>
                                                <p style="padding: 10px 30px; border: 2px solid #24724D; color: #555555; border-radius: 50px; font-size: 19px;"><?php echo $row['school_address']; ?></p>
                                                <br>

                                                <h2 style="color: #555555;">Logo of organization :</h2>
                                                <img src="Organization/<?php echo $row ['logo']?>" alt="" width="150px">
                                            <?php
                                        }
                                    ?>
                                            </div>
