                                            ...
                                            <table class="voters-list">
                                                <tbody>
                                                    <tr style="border-radius: 11px;">
                                                        ...
                                                        <th>
                                                            Last Name
                                                            <a style="color: white; margin-left: 6px;" href="?sort=voters_lastname&order=<?php echo $toggleSortOrder; ?>">
                                                                <i class="fas fa-sort-<?php echo $sortColumn == 'voters_lastname' && $sortOrder == 'ASC' ? 'up' : 'down'; ?>"></i>
                                                            </a>
                                                        </th>
                                                        <th>
                                                            First Name
                                                            <a style="color: white; margin-left: 6px;" href="?sort=voters_firstname&order=<?php echo $toggleSortOrder; ?>">
                                                                <i class="fas fa-sort-<?php echo $sortColumn == 'voters_firstname' && $sortOrder == 'ASC' ? 'up' : 'down'; ?>"></i>
                                                            </a>
                                                        </th>
                                                        <th>
                                                            Voters ID
                                                            <a style="color: white; margin-left: 6px;" href="?sort=voters_id&order=<?php echo $toggleSortOrder; ?>">
                                                                <i class="fas fa-sort-<?php echo $sortColumn == 'voters_id' && $sortOrder == 'ASC' ? 'up' : 'down'; ?>"></i>
                                                            </a>
                                                        </th>
                                                        <th>
                                                            Grade
                                                        ...
                                                        <th>
                                                            Section
                                                            <a style="color: white; margin-left: 6px;" href="?sort=section_id&order=<?php echo $toggleSortOrder; ?>">
                                                                <i class="fas fa-sort-<?php echo $sortColumn == 'section_id' && $sortOrder == 'ASC' ? 'up' : 'down'; ?>"></i>
                                                            </a>
                                                        </th>
